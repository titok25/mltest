 ...
 * IMPORTANTE: Diferencia entre bots do Meta (facebookexternalhit, facebot) e usuários reais do app Instagram
 */
function isBot(userAgent) {
    ...
    const blacklist = [
        ...
        // REMOVIDO: "instagram" - pois bloqueia usuários reais do app
    ...
    // Verificação adicional: Se contém "instagram" mas também contém indicadores de bot
    // Usuários reais do Instagram geralmente têm User-Agent com "Instagram" + Android/iPhone
    // Bots geralmente não têm a estrutura completa de um app real
    if (userAgentLower.includes("instagram")) {
        // Se é mobile E tem instagram, provavelmente é usuário real
        if (isMobile(userAgent)) {
            return false; // Não é bot, é usuário real
        }
    }
